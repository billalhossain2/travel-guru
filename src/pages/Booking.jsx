  ...
  return (
    <div className="flex justify-center">
      <div className="flex lg:flex-row flex-col gap-20 max-w-[90%] mx-auto h-screen mt-20">
        ...
        <form
          action=""
          className="bg-white max-h-[300px] p-5 min-h-[330px] rounded-lg"
        >
          <div className="mb-4">
            <label className="text-black block" htmlFor="origin">
              Origin
            </label>
            <input
              className="bg-[#e6e1e1] p-2 rounded-[2px] font-bold outline-none w-[100%]"
              type="text"
              defaultValue={origin}
            />
          </div>
          <div className="mb-4">
            <label className="text-black block" htmlFor="Destination">
              Destination
            </label>
            <input
              className="bg-[#e6e1e1] p-2 rounded-[2px] font-bold outline-none w-[100%]"
          ...
          <div className="flex gap-3">
            <div className=" ">
              ...
              <input
                ref={dateFromRef}
                className="bg-[#e6e1e1] p-2 rounded-[2px] font-bold outline-none"
                type="date"
              />
            </div>
            <div className="">
          ...
          <div>
            <Link to={`/${destination}/hotels/${id}`}>
              <button className="btn bg-[#F9A51A] hover:bg-[#F9A51A] border-0 w-[100%] mt-5 normal-case">
                Start Booking
              </button>
            </Link>
          </div>
